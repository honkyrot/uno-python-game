...
class UNO_Game:
    ...
    def four_loopback(self, number, increment):
    ...
    def return_assignment(self, number):
    ...
    def check_if_card_can_be_played(self, card):
    ...
    def check_for_action(self, player, card):
    ...
    def discard_played_card(self, player, card, discard=True):
    ...
    def refill_deck(self, player, remaining_amount):
    ...
    def action_skip(self, player, card):
    ...
    def action_draw_two(self, player, card):
    ...
    def action_draw_four_wild(self, player, card):
    ...
    def action_wild(self, player, card):
    ...
    def play_regular_card(self, player, card):
    ...
    def draw_first_card(self):
        ...
        if card.value == "wild":
            ...
            print("Dealer drew a wild +4 card!")
            color = random.choice(["red", "blue", "green", "yellow"])
            card.color = color
            card.value = "+4"
            self.current_card = card
            ...
            print(f"Dealer drew a {card.color.title()} reverse card!")
            self.current_turn += 1
            self.clockwise = not self.clockwise
        elif card.value == "skip":
            print(f"Dealer drew a {card.color.title()} skip card!")
            print(f"Skipped {self.player0.user_name}'s turn.")
            self.current_turn += 1
        elif card.value == "+2":
            target_player = self.return_assignment(0)
            print(f"Dealer drew a {card.color.title()} +2 card!\n"
                  f"{target_player.user_name} draws 2 cards.")
            self.draw_card(target_player, 2)
            self.current_turn += 1
        else:
            print(f"Dealer drew a {card.color.title()} {card.value} card!")
